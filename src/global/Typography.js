...
const typographyVariants = [
  ...
  createClasses(variants.captionText, 'text-sm leading-tight font-semibold font-nunito'),
  createClasses(variants.overLineText, 'text-md font-thin leading-loose font-semibold font-nunito'),
];
