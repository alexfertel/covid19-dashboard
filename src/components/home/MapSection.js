...
const colors = ['bg-gray-4', 'bg-gray-3', 'bg-gray-2', 'bg-red-3', 'bg-red-2', 'bg-red-1'];

const Colors = () =>
  colors.map(color => <div key={color} className={`${color} h-3 w-3 rounded-full border border-white`} />);
    ...
    <div className="px-2 pt-1 pb-2">
      ...
      <div className="flex mt-8">
        <div className="flex items-center justify-between w-full pr-2">
          ...
          <VerticalDivider height="h-2" className="opacity-75" />
          <div className="flex items-center">
